...
export const createComment = (target: SocialTarget, targetId: Id, payload: CreateCommentRequest) =>
  apiClient.post<Comment, CreateCommentRequest>(`${target}/${targetId}/comments`, payload);
