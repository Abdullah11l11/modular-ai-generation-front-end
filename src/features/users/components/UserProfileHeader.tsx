...
export function UserProfileHeader ({user ,templatesCount ,resourcesCount ,upvotesCount} : UserProfileHeaderProps) {
...
return (
    <div className="flex items-start gap-4 p-6">
        ...
        <div className="space-y-1">
            ...
            <p className="text-sm"><strong className="text-base">{templatesCount ?? 0}</strong> Templates</p>
            <p className="text-sm"><strong className="text-base">{resourcesCount ?? 0}</strong> Resources</p>
            <p className="text-sm"><strong className="text-base">{upvotesCount ?? 0}</strong> Upvotes</p>
            </div>
