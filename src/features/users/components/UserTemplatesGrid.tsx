...
const mockTemplates: Template[] = [
  {
    id: '1', user_id: '1', name: 'Business Pitch Deck',
    description: null, thumbnail_url: null, visibility: 'public',
    tags: ['business'], locale: 'en', direction: 'ltr',
    fork_count: 5, upvote_count: 12, is_upvoted: false, is_bookmarked: false,
